...
# Profinet Device Control Protocol (PNDCP) Header
...
# Profinet Device Control Protocol (PNDCP) Block request
...
# Profinet Device Control Protocol (PNDCP) Block（ represents a block within a PNDCP packet）
...
# Profinet Remote Procedure Call (RPC) header
...
# Profinet Network Read Data (PNNRD)
...
# AR" 代表在周期性实时数据交换之外进行的通信, Acyclic Request
...
# Profinet IOD (IOD: Input/Output Data) release block
